...
public class ProblemReporter {
    ...
    private static String composeBody(Activity activity, String gameMode) {
        StringBuilder sb = new StringBuilder();

        sb.append(activity.getString(R.string.report_email_content));

        sb.append(activity.getString(R.string.report_game_mode) + ":" + gameMode + "\n");
    ...
    public static void report(Activity activity, String gameMode) {
        ...
        i.putExtra(Intent.EXTRA_TEXT, composeBody(activity, gameMode));
