...
public class AimedIndestructibleFiringEnemy extends BaseEnemy {

    private static final long serialVersionUID = 4419589376462776493L;
    public static final int COLOR = Color.HSVToColor(new float[] { 30, 0.7f, 0.5f });
    ...
    public AimedIndestructibleFiringEnemy(Vector position) {
