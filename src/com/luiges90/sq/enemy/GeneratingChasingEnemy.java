...
public class GeneratingChasingEnemy extends BaseEnemy {

    private static final long serialVersionUID = -7813334082325203249L;
    public static final int COLOR = Color.HSVToColor(new float[] { 110, 0.9f, 0.5f });
